  ...
  <main class="content">
    ...
    <div class="cards-grid" style="margin-bottom:24px">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">${mesa.capacidade} lugares</div>
      </div>
        ...
        <div class="stat-value" style="font-size:18px">
          <c:choose>
            ...
            <c:when test="${mesa.status=='ocupada'}">
              <span style="color:#ef4444">🔴 Ocupada</span>
            </c:when>
            <c:otherwise>
              <span style="color:#f59e0b">🟡 Reservada</span>
            </c:otherwise>
          </c:choose>
        </div>
      </div>

      <%-- Última ação — vem de mesa.operador + mesa.dataStatus (v2) --%>
