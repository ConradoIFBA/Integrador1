					...
					<form method="POST"
						...
						<div class="form-group">
							<label for="categoriaId">Categoria <span
								style="color: #ef4444">*</span></label> <select id="categoriaId"
						...
						<div class="form-group">
							<label for="nome">Nome do item <span
								style="color: #ef4444">*</span></label> <input type="text" id="nome"
						...
						<div class="form-row">
							<div class="form-group">
								<label for="preco">Preço (R$) <span
									style="color: #ef4444">*</span></label> <input type="number" id="preco"
							...
							<div class="form-group">
								<label for="tempoPreparoMin">Tempo preparo (min) <span
									style="color: #ef4444">*</span></label> <input type="number"
