...
public class Pedido implements Serializable {
	...
	public Pedido(int id, Integer mesaId, String tipo, boolean urgente, String operador, String status, String obs,
			LocalDateTime dataAbertura, boolean ativo) {
		this.idPedido = id;
		this.mesaId = mesaId;
		this.tipo = tipo;
		this.urgente = urgente;
	...
	public void setMesaId(Integer v) {
		mesaId = v;
	}
	...
	public void setUrgente(boolean v) {
		urgente = v;
	}
	...
	public void setItens(List<ItemPedido> v) {
		itens = v;
	}

	/** Usado nos JSPs: ${p.dataAberturaFormatada} */
	public String getDataAberturaFormatada() {
		return dataAbertura != null ? dataAbertura.format(FMT) : "";
	}

	public String getDataAberturaHora() {
		return dataAbertura != null ? dataAbertura.format(FMT_HORA) : "";
	}
