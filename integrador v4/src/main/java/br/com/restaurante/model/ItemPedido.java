...
public class ItemPedido implements Serializable {
	...
	public ItemPedido(int id, int pedidoId, int itemCardapioId, int qtd, BigDecimal preco, String obs, String status,
			boolean ativo) {
	...
	public void setIdItemPedido(int v) {
		idItemPedido = v;
	}
	...
	public void setItemCardapioId(int v) {
		itemCardapioId = v;
	}
	...
	public void setItemCardapio(Cardapio v) {
		cardapio = v;
	}
	...
	public void setPrecoUnitario(BigDecimal v) {
		precoUnitario = v;
	}
	...
	public String getNomeItem() {
		return cardapio != null ? cardapio.getNome() : "";
	}
