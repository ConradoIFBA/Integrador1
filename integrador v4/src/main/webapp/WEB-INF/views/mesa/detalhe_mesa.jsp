...
<%--
    ...
    ================================================================
    Esta página já usava quase só classes globais do style.css
    (.stat-card, .card, .table-wrapper, .badge) em vez de estilos
    próprios — por isso ela HERDOU o tema escuro automaticamente
    assim que o style.css foi trocado, sem precisar de <style>
    próprio. As únicas mudanças aqui foram: trocar as cores
    hard-coded inline (style="color:#10b981" etc., que ficariam
    ilegíveis num fundo escuro) pelas variáveis CSS do tema, e
    adicionar um ícone colorido (.icon-box) no card de status, para
    ficar visualmente consistente com os stat-cards do Painel/Mesas.
