...
.periodo-card.selecionado {
	border-color: var(--primary);
	background: var(--primary-light)
}

.periodo-card input[type=radio] {
	display: none
}
				...
				<div class="layout-rel">
					...
					<div>
						<div class="card">
							...
							<form method="POST"
								action="${pageContext.request.contextPath}/app/relatorios"
								...
								<div style="margin-bottom: 16px">
									...
									<div class="periodo-grid">
										...
										<label class="periodo-card" id="card-hoje"> <input
											type="radio" name="periodo" value="hoje"
											onchange="selecionarPeriodo('hoje')">
											<div class="icon">📅</div>
											<div class="label">Hoje</div>
											<div class="desc" id="desc-hoje">—</div>
										</label> <label class="periodo-card" id="card-semana"> <input
											type="radio" name="periodo" value="semana"
											onchange="selecionarPeriodo('semana')">
											<div class="icon">📆</div>
											<div class="label">Últimos 7 dias</div>
											<div class="desc" id="desc-semana">—</div>
										</label> <label class="periodo-card selecionado" id="card-mes">
										...
										</label> <label class="periodo-card" id="card-customizado"> <input
											type="radio" name="periodo" value="customizado"
								...
								<div class="datas-custom" id="datasCustom">
									<div class="datas-row">
										<div class="form-group" style="margin: 0">
											<label for="dataInicio">Data inicial</label> <input
												type="date" id="dataInicio" name="dataInicio"
												value="${dataInicioDefault}" required>
										</div>
										<div class="form-group" style="margin: 0">
											<label for="dataFim">Data final</label> <input type="date"
												id="dataFim" name="dataFim" value="${dataFimDefault}"
												required>
										</div>
									</div>
								</div>
						...
						<div class="card" style="margin-top: 20px">
							...
							<div style="display: flex; flex-direction: column; gap: 12px">
								<div class="check-linha">
									<span
										style="color: var(--success-color); font-weight: 700; flex-shrink: 0">✓</span>
									<span><strong>Resumo do período</strong> — total de
										pedidos, faturamento e ticket médio</span>
								</div>
								<div class="check-linha">
									<span
										style="color: var(--success-color); font-weight: 700; flex-shrink: 0">✓</span>
									<span><strong>Faturamento por categoria</strong> —
										Entradas, Pratos, Bebidas, Sobremesas</span>
								</div>
								<div class="check-linha">
									<span
										style="color: var(--success-color); font-weight: 700; flex-shrink: 0">✓</span>
									<span><strong>Detalhamento dos pedidos</strong> — todos
										os pedidos entregues no período</span>
								</div>
								<div class="check-linha">
									<span
										style="color: var(--info-color); font-weight: 700; flex-shrink: 0">ℹ</span>
									<span class="text-muted">Apenas pedidos com status <strong>entregue</strong>
										são incluídos.
									</span>
								</div>
							</div>
					...
					<div>
						<div class="card">
							<h3>📊 Como usar</h3>
							<div
								style="font-size: 13px; color: var(--text-secondary); display: flex; flex-direction: column; gap: 12px">
								<div>
									<strong style="color: var(--text-primary)">Passo 1</strong><br>Selecione
									o período desejado nos cards à esquerda.
								</div>
								<div>
									<strong style="color: var(--text-primary)">Passo 2</strong><br>Clique
									em <strong>Gerar PDF</strong>. O download começa
									automaticamente.
								</div>
								<div>
									<strong style="color: var(--text-primary)">Passo 3</strong><br>Abra
									o arquivo PDF gerado para visualizar ou imprimir o relatório.
								</div>
							</div>
						</div>
						...
						<div class="card" style="margin-top: 16px">
							...
							<div
								style="font-size: 13px; color: var(--text-secondary); display: flex; flex-direction: column; gap: 8px">
								<div class="historico-item">
									<span>📅 Hoje</span> <span id="info-hoje"
										style="color: var(--text-primary); font-weight: 600">—</span>
								</div>
								<div class="historico-item">
									<span>📆 Últimos 7 dias</span> <span id="info-semana"
										style="color: var(--text-primary); font-weight: 600">—</span>
								</div>
								<div class="historico-item">
									<span>🗓️ Mês atual</span> <span id="info-mes"
										style="color: var(--text-primary); font-weight: 600">—</span>
								</div>
							</div>
						</div>
