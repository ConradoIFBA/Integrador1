...
<%--
    ================================================================
    DELIVERY.JSP — MONTAR PEDIDO DE DELIVERY (v4)
    ================================================================
	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<main class="content">
				...
				<form method="POST"
					action="${pageContext.request.contextPath}/app/cliente/delivery"
										...
										<c:forEach var="item" items="${itens}">
											<div class="item-linha" id="card-${item.idItem}"
												...
												<div>
													...
													<div class="item-cat">${item.nomeCategoria} · ⏱
							...
							<div class="card">
								...
								<div style="margin-top: 10px">
									<a
										...
										style="width: 100%; text-align: center"> Ver meus pedidos
									</a>
								</div>
							</div>
						</div>
