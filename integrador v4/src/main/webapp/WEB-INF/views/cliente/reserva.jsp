...
.mesa-card.livre:hover {
	border-color: var(--success-color)
}

.mesa-card.ocupada, .mesa-card.reservada {
	opacity: .55
}
	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<main class="content">
				...
				<div class="legenda">
					<span><span class="dot"
						style="background: var(--success-color)"></span>Livre — clique
						para reservar</span> <span><span class="dot"
						style="background: var(--error-color)"></span>Ocupada —
						indisponível</span> <span><span class="dot"
						style="background: var(--warning-color)"></span>Reservada —
						indisponível</span>
				</div>
									...
									<c:if test="${mesa.status == 'livre'}">
										<form method="POST"
											...
											<button type="submit" class="btn btn-primary btn-sm"
												style="width: 100%">Reservar esta mesa</button>
										</form>
									</c:if>
