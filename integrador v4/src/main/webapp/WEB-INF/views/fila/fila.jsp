...
.setor-cozinha   .setor-titulo {
	background: #c2410c
}

.setor-bebida    .setor-titulo {
	background: #2563eb
}

.setor-sobremesa .setor-titulo {
	background: #be185d
}
...
<body>
			...
			<header class="topbar">
				...
				<div class="topbar-right">
					<button onclick="location.reload()"
						class="btn btn-secondary btn-sm">🔄 Atualizar</button>
				...
				<div class="setores-grid">
					...
					<div class="setor-cozinha setor-coluna">
						<div class="setor-titulo">
							<span>🔥 Cozinha</span> <span class="contador">${fn:length(filaCozinha)}</span>
						</div>
					...
					<div class="setor-bebida setor-coluna">
						<div class="setor-titulo">
							<span>🥤 Bebidas</span> <span class="contador">${fn:length(filaBebida)}</span>
						</div>
						<div class="setor-body">
							<c:choose>
					...
					<div class="setor-sobremesa setor-coluna">
						<div class="setor-titulo">
							<span>🍮 Sobremesas</span> <span class="contador">${fn:length(filaSobremesa)}</span>
						</div>
						<div class="setor-body">
							<c:choose>
	...
	<div class="modal-overlay" id="modalOverlay">
		<div class="modal">
			...
			<form method="POST"
				action="${pageContext.request.contextPath}/app/fila" id="formModal">
				<input type="hidden" name="acao" id="modalAcao"> <input
					type="hidden" name="idFila" id="modalIdFila"> <input
					type="hidden" name="idPedido" id="modalIdPedido">
